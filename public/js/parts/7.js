...
/* harmony import */ var vue_tribute__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! vue-tribute */ "./node_modules/vue-tribute/dist/vue-tribute.es.js");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    ...
    VueTribute: vue_tribute__WEBPACK_IMPORTED_MODULE_3__["default"]
  },
    ...
    return {
      tributeOptions: {
        ...
        values: function values(text, cb) {
          getSuggestions(text, function (suggestions) {
  ...
  methods: {
    ...
    getSuggestions: function getSuggestions(text, cb) {
      axios.post('');
    }
  }
});
